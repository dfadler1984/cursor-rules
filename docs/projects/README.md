...
- **README** - Project overview and navigation
- **CHANGELOG** (Optional) - Project evolution, decisions, and milestones (recommended for complex projects >15 files)
...
Complex projects (especially investigations with >15 files) can include a `CHANGELOG.md` to track:

- Project evolution and major changes
- Key decisions with rationale
- Phase transitions and milestones

**When to use**: Investigations, multi-session projects, when returning contributors need quick context

**Template**: `.cursor/templates/project-lifecycle/CHANGELOG.template.md`

**See**:

- [Rules-Enforcement Investigation CHANGELOG](./rules-enforcement-investigation/CHANGELOG.md) — Example
- [Per-Project Changelog](./per-project-changelog/) — Implementation project
- [project-lifecycle.mdc](./../.cursor/rules/project-lifecycle.mdc) — Full guidance
