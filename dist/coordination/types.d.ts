...
export type MessageType = "connected" | "register" | "registered" | "create_tasks" | "tasks_created" | "request_task" | "task_assigned" | "no_tasks" | "task_complete" | "task_complete_ack" | "report_detected" | "worker_registered" | "status" | "status_response" | "server_shutdown" | "error";
...
export type ServerMessage = RegisterMessage | CreateTasksMessage | RequestTaskMessage | TaskCompleteMessage | StatusMessage;
export type ClientMessage = RegisteredMessage | TasksCreatedMessage | TaskAssignedMessage | TaskCompleteMessage | StatusResponseMessage | ErrorMessage;
