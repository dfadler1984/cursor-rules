...
SUT="$SCRIPT_DIR/test-colocation-migrate.sh"

echo "[TEST] test-colocation-migrate.sh (help migration)"
...
test_help_complete
echo "[TEST] test-colocation-migrate.sh (help): All tests passed"
exit 0
